...
/*The router function looks for changes in the url and adjust the html content of 
the <main></main> tag accordingly in index.html*/
async function route() {
  //Checks to see if anyone is logged in so that it can show/hide the logout button accordingly
  ...
  //the switch statement that checks for all possible url's
